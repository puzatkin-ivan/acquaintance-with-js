...
function checkDigit(firstDigit, secondDigit) {
...
function showPrimeDigit(beginInterval, endInterval) {
...
if (checkDigit(beginingInterval, endInterval)) {
  showPrimeDigit(beginingInterval, endInterval);
} else {
